...
public sealed class ByteExecutionTests
{
    ...
    public void EmitManagedApplication_ExecutesByteConversionsAndArithmetic()
    {
        var compilation = VBCompilation.Create("""
            ...
            End Sub
            """, "Module1.bas");
        var directory = Path.Combine(Path.GetTempPath(), "VB6CompilerByteTests", Guid.NewGuid().ToString("N"));
        var assemblyPath = Path.Combine(directory, "ByteProgram.dll");
        ...
        try
        {
            ...
            using var process = Process.Start(startInfo)
                ?? throw new InvalidOperationException("Failed to start the generated Byte application.");
