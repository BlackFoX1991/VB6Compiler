...
public sealed class ConformanceCorpusTests
{
    ...
    /// closeout, 1214 after the UDT type space, 480 after With and member access, 466 with untyped functions, 454 once ReDim recovery stopped a cascade.
    ///
    ...
    /// </summary>
    private const int VisiaParserErrorBaseline = 454;
