...
public sealed class ConformanceCorpusTests
{
    ...
    /// closeout, 1214 after the UDT type space, 480 after With and member access, 466 with untyped functions, 454 once ReDim recovery stopped a cascade, 218 with file numbers lexed and the binary file statements parsed, 122 once TypeOf parsed, 83 with call-site ByVal, 49 once On Error, GoTo and labels parsed.
    ///
    ...
    /// </summary>
    private const int VisiaParserErrorBaseline = 49;
