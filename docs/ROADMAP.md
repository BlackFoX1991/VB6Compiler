...
Messung vom 2026-09-05 auf `main` / `3e8bd47` mit nicht committeten Änderungen, Lauf `20260905T191927Z-7f7bb76f`:
...
**Kompatibilitätsmatrix nach der Restplanung:** **162 Erwartungen**, davon **140 implemented**, **0 partial** und **22 planned**;
**140/162 documented-verified**, 22 `not-yet-verified`, 0 `oracle-verified`.
...
Die 22 folgenden Karten sind `planned` / `not-yet-verified`. R0 ist geschlossen und steht als
