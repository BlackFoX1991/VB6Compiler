...
- [~] LLVM-natives Windows-Backend für x86 und x64 — primitive skalare IR-Emission für x86/x64 einschließlich globaler Slots, skalierter Currency-Literale, sicherer skalare Konversionen und skalarer `Declare`-Verträge steht; geprüfte/rundende Konversionen, geprüfte Single-Arithmetik, Floating-Division, geprüfte Integer-Division und Restbildung, Currency-Multiplikationsskalierung sowie native ABI-/Runtime-Emission für komplexe VB6-Werte bleiben offen
