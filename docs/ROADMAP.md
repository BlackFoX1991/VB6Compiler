...
**820 Tests**. Gerundete Single-/Double-zu-Integer-Konversionen bis 32 Bit verwenden nun
`llvm.roundeven.f64`, NaN-/Range-Guards und sichere `fptosi`/`fptoui`-Konversionen. Typisierte
