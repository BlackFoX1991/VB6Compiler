...
internal static class VBIntrinsicSymbols
{
    private static readonly ImmutableArray<ProcedureSymbol> Intrinsics = ImmutableArray.Create(
        ...
        Function(
            ...
            Parameter("Expression", TypeSymbol.String),
            Parameter("Length", TypeSymbol.Long)),
        Function("UCase", VBIntrinsicKind.UCase, "VBStrings.UCase", TypeSymbol.Variant, Parameter("Expression", TypeSymbol.Variant)),
        Function("LCase", VBIntrinsicKind.LCase, "VBStrings.LCase", TypeSymbol.Variant, Parameter("Expression", TypeSymbol.Variant)),
        Function("Trim", VBIntrinsicKind.Trim, "VBStrings.Trim", TypeSymbol.Variant, Parameter("Expression", TypeSymbol.Variant)),
        Function("LTrim", VBIntrinsicKind.LTrim, "VBStrings.LTrim", TypeSymbol.Variant, Parameter("Expression", TypeSymbol.Variant)),
        Function("RTrim", VBIntrinsicKind.RTrim, "VBStrings.RTrim", TypeSymbol.Variant, Parameter("Expression", TypeSymbol.Variant)),
        ...
        Function("StrReverse", VBIntrinsicKind.StrReverse, "VBStrings.StrReverse", TypeSymbol.String, Parameter("Expression", TypeSymbol.String)),
        Function(
            "FormatNumber",
            VBIntrinsicKind.FormatNumber,
            "VBStrings.FormatNumber",
            TypeSymbol.String,
            Parameter("Expression", TypeSymbol.Variant),
            OptionalParameter("NumDigitsAfterDecimal", TypeSymbol.Long, -1L),
            OptionalParameter("IncludeLeadingDigit", TypeSymbol.Long, -2L),
            OptionalParameter("UseParensForNegativeNumbers", TypeSymbol.Long, -2L),
            OptionalParameter("GroupDigits", TypeSymbol.Long, -2L)),
        Function(
            "FormatCurrency",
            VBIntrinsicKind.FormatCurrency,
            "VBStrings.FormatCurrency",
            TypeSymbol.String,
            Parameter("Expression", TypeSymbol.Variant),
            OptionalParameter("NumDigitsAfterDecimal", TypeSymbol.Long, -1L),
            OptionalParameter("IncludeLeadingDigit", TypeSymbol.Long, -2L),
        ...
        Function(
            "FormatPercent",
            VBIntrinsicKind.FormatPercent,
            "VBStrings.FormatPercent",
            TypeSymbol.String,
            Parameter("Expression", TypeSymbol.Variant),
            OptionalParameter("NumDigitsAfterDecimal", TypeSymbol.Long, -1L),
            OptionalParameter("IncludeLeadingDigit", TypeSymbol.Long, -2L),
        ...
        Function(
            "FormatDateTime",
            VBIntrinsicKind.FormatDateTime,
            "VBStrings.FormatDateTime",
            TypeSymbol.String,
            Parameter("Date", TypeSymbol.Variant),
            OptionalParameter("NamedFormat", TypeSymbol.Long, 0L)),
        Function(
            "Partition",
            VBIntrinsicKind.Partition,
            "VBStrings.Partition",
            TypeSymbol.String,
            Parameter("Number", TypeSymbol.Long),
            Parameter("Start", TypeSymbol.Long),
            Parameter("Stop", TypeSymbol.Long),
            Parameter("Interval", TypeSymbol.Long)),
        ...
        Function(
            "CallByName",
            VBIntrinsicKind.CallByName,
            "VBFunctions.CallByName",
            TypeSymbol.Variant,
            Parameter("Object", TypeSymbol.Variant),
            Parameter("ProcName", TypeSymbol.String),
            Parameter("CallType", TypeSymbol.Long),
        ...
        Function(
            "LoadResString",
            VBIntrinsicKind.LoadResString,
            "VBResourceIntrinsics.LoadResString",
            TypeSymbol.String,
            Parameter("Index", TypeSymbol.Long)),
        Function(
            "LoadResData",
            VBIntrinsicKind.LoadResData,
            "VBResourceIntrinsics.LoadResData",
            new ArrayTypeSymbol(TypeSymbol.Byte, 1),
            Parameter("Index", TypeSymbol.Long),
            Parameter("Format", TypeSymbol.Variant)),
        Function(
            "LoadResPicture",
            VBIntrinsicKind.LoadResPicture,
            "VBResourceIntrinsics.LoadResPicture",
