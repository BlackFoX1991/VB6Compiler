...
internal static class VBIntrinsicSymbols
{
    private static readonly ImmutableArray<ProcedureSymbol> Intrinsics = ImmutableArray.Create(
        ...
        Function("DateDiff", VBIntrinsicKind.DateDiff, "VBDateTime.DateDiff", TypeSymbol.Long, Parameter("Interval", TypeSymbol.String), Parameter("Date1", TypeSymbol.Date), Parameter("Date2", TypeSymbol.Date)),
