...
internal static class VBBuiltInConstants
{
    private static readonly ImmutableArray<BoundModuleVariable> Constants =
        ImmutableArray.Create(
            ...
            CreateLong("vbUseSystem", 0),
            CreateLong("vbUseDefault", -2),
            CreateLong("vbGeneralDate", 0),
            CreateLong("vbLongDate", 1),
            CreateLong("vbShortDate", 2),
            CreateLong("vbLongTime", 3),
            CreateLong("vbShortTime", 4),
            CreateLong("vbMethod", 1),
            CreateLong("vbGet", 2),
            CreateLong("vbLet", 4),
            CreateLong("vbSet", 8),
            CreateLong("vbSunday", 1),
            CreateLong("vbMonday", 2),
            CreateLong("vbTuesday", 3),
            CreateLong("vbWednesday", 4),
            CreateLong("vbThursday", 5),
            CreateLong("vbFriday", 6),
            CreateLong("vbSaturday", 7),
            CreateLong("vbFirstJan1", 1),
            CreateLong("vbFirstFourDays", 2),
            CreateLong("vbFirstFullWeek", 3),
            ...
            CreateLong("vbCFText", 1),
            CreateLong("vbCFBitmap", 2),
            CreateLong("vbCFMetafile", 3),
            CreateLong("vbCFDIB", 8),
            CreateLong("vbCFPalette", 9),
            CreateLong("vbCFUnicodeText", 13),
            CreateLong("vbCFEMetafile", 14),
            CreateLong("vbCFFiles", 15),
            CreateLong("vbCFLink", -16640),
            CreateLong("vbCFRTF", -16639),
            CreateLong("vbPRORPortrait", 1),
            CreateLong("vbPRORLandscape", 2),
            CreateLong("vbPRCMMonochrome", 1),
            CreateLong("vbPRCMColor", 2),
            CreateLong("vbPRDPSimplex", 1),
            CreateLong("vbPRDPHorizontal", 2),
            CreateLong("vbPRDPVertical", 3),
            CreateLong("vbPRPQDraft", -1),
            CreateLong("vbPRPQLow", -2),
            CreateLong("vbPRPQMedium", -3),
            CreateLong("vbPRPQHigh", -4),
            CreateLong("vbUser", 0),
            CreateLong("vbTwips", 1),
            CreateLong("vbPoints", 2),
            CreateLong("vbPixels", 3),
            CreateLong("vbCharacters", 4),
            CreateLong("vbInches", 5),
            CreateLong("vbMillimeters", 6),
            CreateLong("vbCentimeters", 7),
            CreateLong("rtfRTF", 0),
