...
public static class IrLowerer
{
    ...
    private sealed class ProcedureLowerer
    {
        ...
        /// Long, LongLong, Boolean, Single, Double, Date and Currency slots. Boolean is
        /// represented by a separate two-byte -1/0 cell, LongLong by an eight-byte signed cell,
        /// Single and Double use their IEEE-754 cells, Date uses its eight-byte Automation date
        /// layout, and Currency its scaled Int64 layout; strings, Variants, UDTs and aggregate
        /// storage need their own ABI layouts before they can make the same promise.
        /// </summary>
        ...
        private static IrRuntimeMethod IntrinsicMethod(string target) => target switch
        {
            ...
            "VBResourceIntrinsics.LoadResString" => IrRuntimeMethod.LoadResString,
            "VBResourceIntrinsics.LoadResData" => IrRuntimeMethod.LoadResData,
            "VBResourceIntrinsics.LoadResPicture" => IrRuntimeMethod.LoadResPicture,
            ...
            "VBFiles.FileAttr" => IrRuntimeMethod.FileAttr,
            "VBInteraction.IMEStatus" => IrRuntimeMethod.IMEStatus,
