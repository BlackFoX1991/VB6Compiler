...
Measured on 2026-09-06 at `c793ae4` on `main` with uncommitted changes, run `20260906T130143Z-99360290`:
...
| Standard serial run, 13 test projects | 1743 cases: 1743 passed, 0 failed | Serial run across every test project |
