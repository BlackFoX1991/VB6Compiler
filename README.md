...
Measured on 2026-09-06 at `a0c6387` on `main`, run `20260906T075827Z-9f96c632`:
...
| Standard serial run, 13 test projects | 1719 cases: 1719 passed, 0 failed | Serial run across every test project |
