...
Measured on 2026-09-06 at `6180b2f` on `main` with uncommitted changes, run `20260906T092306Z-b194307f`:
...
| Standard serial run, 13 test projects | 1733 cases: 1733 passed, 0 failed | Serial run across every test project |
