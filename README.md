...
- the regression suite currently contains **924 tests**, including typed string-key Variant, Object, compiled COM automation dispatch, conditional compilation, UDT `Len`/`LenB` layout, and legacy `.dsr` project emission
