...
- the regression suite currently contains **921 tests**, including typed string-key Variant, Object, compiled COM automation dispatch, conditional compilation, UDT `Len` layout, and legacy `.dsr` project emission
