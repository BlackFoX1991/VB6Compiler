...
Measured on 2026-09-06 at `97ebcb4` on `main` with uncommitted changes, run `20260906T132941Z-1fe108d7`:
...
| Standard serial run, 13 test projects | 1747 cases: 1747 passed, 0 failed | Serial run across every test project |
