...
- the regression suite currently contains **879 tests**, including typed string-key Variant, Object, named default-property and COM `DISPID_VALUE` dispatch
