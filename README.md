...
- the regression suite currently contains **907 tests**, including typed string-key Variant, Object, compiled COM automation dispatch, and legacy `.dsr` project emission
