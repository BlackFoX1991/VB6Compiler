...
- late-bound `Variant`/`Object` member dispatch for generated Managed classes, including Property Get/Let/Set and method calls, with optional arguments, `ParamArray`, typed CLR property/indexer conversion, and ByRef write-back for Managed/CLR targets; COM/IDispatch identity and COM ByRef/event ABI remain open
...
- the regression suite currently contains **852 tests**, including typed string-key Variant, Object and named default-property dispatch
