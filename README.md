...
- the regression suite currently contains **882 tests**, including typed string-key Variant, Object, named default-property and COM `DISPID_VALUE` dispatch
