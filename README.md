...
- the regression suite currently contains **871 tests**, including typed string-key Variant, Object, named default-property and COM `DISPID_VALUE` dispatch
