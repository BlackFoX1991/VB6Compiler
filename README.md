...
Measured on 2026-09-06 at `137d3ab` on `main` with uncommitted changes, run `20260906T100439Z-314846c1`:
...
| Standard serial run, 13 test projects | 1739 cases: 1739 passed, 0 failed | Serial run across every test project |
