...
The compatibility matrix contains 171 expectations (147 implemented, 3 partial, 21 planned) with 150/171 documented-verified.
...
Measured on 2026-09-09 at `ec74093` on `main` with uncommitted changes, run `20260909T075751Z-6d481f01`:
...
| Standard serial run, 13 test projects | 1827 cases: 1827 passed, 0 failed | Serial run across every test project |
...
The matrix reports **171 expectations**: **147 implemented**, **3 partial**, **21 planned**;
**150 documented-verified**, **21 not-yet-verified**, **0 oracle-verified**.
