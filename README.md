...
Measured on 2026-09-06 at `230d1f1` on `main`, run `20260906T163223Z-9a43fd40`:
...
| Standard serial run, 13 test projects | 1755 cases: 1755 passed, 0 failed | Serial run across every test project |
