...
- the regression suite currently contains **927 tests**, including typed string-key Variant, Object, compiled COM automation dispatch, conditional compilation, UDT `Len`/`LenB` layout, managed CommonDialog/TreeView/ImageList adapters, and legacy `.dsr` project emission
