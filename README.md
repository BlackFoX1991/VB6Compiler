...
- the regression suite currently contains **916 tests**, including typed string-key Variant, Object, compiled COM automation dispatch, conditional compilation, and legacy `.dsr` project emission
