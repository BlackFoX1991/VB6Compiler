...
Measured on 2026-09-06 at `a22ec41` on `main` with uncommitted changes, run `20260906T124501Z-f72a3316`:
...
| Standard serial run, 13 test projects | 1741 cases: 1741 passed, 0 failed | Serial run across every test project |
