...
Measured on 2026-09-06 at `7fe00e3` on `main` with uncommitted changes, run `20260906T082045Z-e348cc8a`:
...
| Standard serial run, 13 test projects | 1725 cases: 1725 passed, 0 failed | Serial run across every test project |
