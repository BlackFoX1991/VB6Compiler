...
- the regression suite currently contains **918 tests**, including typed string-key Variant, Object, compiled COM automation dispatch, conditional compilation, and legacy `.dsr` project emission
