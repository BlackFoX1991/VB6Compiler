...
Measured on 2026-09-06 at `f243a10` on `main` with uncommitted changes, run `20260906T090653Z-54b01849`:
...
| Standard serial run, 13 test projects | 1731 cases: 1731 passed, 0 failed | Serial run across every test project |
