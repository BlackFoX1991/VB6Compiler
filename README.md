...
The compatibility matrix contains 162 expectations (144 implemented, 0 partial, 18 planned) with 144/162 documented-verified.
...
Measured on 2026-09-06 at `c587ce1` on `main` with uncommitted changes, run `20260906T183210Z-e3cb3858`:
...
| Standard serial run, 13 test projects | 1771 cases: 1771 passed, 0 failed | Serial run across every test project |
...
The matrix reports **162 expectations**: **144 implemented**, **0 partial**, **18 planned**;
