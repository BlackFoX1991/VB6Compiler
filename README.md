...
- the regression suite currently contains **926 tests**, including typed string-key Variant, Object, compiled COM automation dispatch, conditional compilation, UDT `Len`/`LenB` layout, managed CommonDialog/TreeView adapters, and legacy `.dsr` project emission
