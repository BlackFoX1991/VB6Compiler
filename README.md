...
The compatibility matrix contains 172 expectations (159 implemented, 0 partial, 13 planned) with 159/172 documented-verified.
...
Measured on 2026-09-09 at `bf31edf` on `main` with uncommitted changes, run `20260909T183515Z-f922c736`:
...
| Standard serial run, 13 test projects | 1847 cases: 1847 passed, 0 failed | Serial run across every test project |
...
The matrix reports **172 expectations**: **159 implemented**, **0 partial**, **13 planned**;
**159 documented-verified**, **13 not-yet-verified**, **0 oracle-verified**.
