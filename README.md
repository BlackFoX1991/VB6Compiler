...
Measured on 2026-09-06 at `8c058ba` on `main` with uncommitted changes, run `20260906T093651Z-16ea2a16`:
...
| Standard serial run, 13 test projects | 1735 cases: 1735 passed, 0 failed | Serial run across every test project |
