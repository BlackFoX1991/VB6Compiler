...
Measured on 2026-09-06 at `4a45f6b` on `main` with uncommitted changes, run `20260906T131622Z-dce88bb2`:
...
| Standard serial run, 13 test projects | 1745 cases: 1745 passed, 0 failed | Serial run across every test project |
