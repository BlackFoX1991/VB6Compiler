...
Measured on 2026-09-06 at `e52459f` on `main` with uncommitted changes, run `20260906T095035Z-33c8a337`:
...
| Standard serial run, 13 test projects | 1737 cases: 1737 passed, 0 failed | Serial run across every test project |
