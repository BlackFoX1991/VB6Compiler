...
Measured on 2026-09-06 at `4ad1b7a` on `main` with uncommitted changes, run `20260906T134346Z-cfaa7fdc`:
...
| Standard serial run, 13 test projects | 1749 cases: 1749 passed, 0 failed | Serial run across every test project |
