...
The compatibility matrix contains 172 expectations (160 implemented, 0 partial, 12 planned) with 160/172 documented-verified.
...
Measured on 2026-09-09 at `9664a20` on `main` with uncommitted changes, run `20260909T190441Z-4dbd2109`:
...
| Standard serial run, 13 test projects | 1851 cases: 1851 passed, 0 failed | Serial run across every test project |
...
The matrix reports **172 expectations**: **160 implemented**, **0 partial**, **12 planned**;
