...
Measured on 2026-09-07 at `f6a91f2` on `r3-cell-visibility`, run `20260907T092104Z-6a59e9ce`:
...
| Standard serial run, 13 test projects | 1787 cases: 1787 passed, 0 failed | Serial run across every test project |
