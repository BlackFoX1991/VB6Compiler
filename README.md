...
The compatibility matrix contains 173 expectations (163 implemented, 0 partial, 10 planned) with 163/173 documented-verified.
...
Measured on 2026-09-10 at `ef6ca10` on `main` with uncommitted changes, run `20260910T070356Z-603e38c1`:
...
| Standard serial run, 13 test projects | 1858 cases: 1858 passed, 0 failed, 0 skipped | Serial run across every test project |
...
The matrix reports **173 expectations**: **163 implemented**, **0 partial**, **10 planned**;
