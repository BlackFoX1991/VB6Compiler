...
- the regression suite currently contains **938 tests**, including typed string-key Variant, Object, compiled COM automation dispatch, conditional compilation, UDT `Len`/`LenB` layout, managed CommonDialog/TreeView/ImageList/RichTextBox/Shape/Line/Menu adapters, `.frx` resource extraction, a WinForms generated-assembly runner, and legacy `.dsr` project emission
